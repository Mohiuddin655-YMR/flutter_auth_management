...
@immutable
class IGoogleSignInInitParameters {
  /// The parameters to use when initializing the sign in process.
...
class IGoogleSignInUserData {
  ...
  bool operator ==(Object other) {
    ...
    if (other is! IGoogleSignInUserData) {
      return false;
    }
    final IGoogleSignInUserData otherUserData = other;
...
class IGoogleSignInTokenData {
  ...
  bool operator ==(Object other) {
    ...
    if (other is! IGoogleSignInTokenData) {
      return false;
    }
    final IGoogleSignInTokenData otherTokenData = other;
